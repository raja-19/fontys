 ...
 *       &lt;sequence&gt;
 *         &lt;element name="WebServiceInfo" type="{http://www.everest.nl/aquima/studio/ManagementService/1.0}WebServiceInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfWebServiceInfo", propOrder = {
    "webServiceInfo"
})
public class ArrayOfWebServiceInfo {

    @XmlElement(name = "WebServiceInfo", namespace = "http://www.everest.nl/aquima/studio/ManagementService/1.0", nillable = true)
