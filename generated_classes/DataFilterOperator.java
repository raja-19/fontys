...
/**
 * <p>Java class for DataFilterOperator.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>
 * &lt;simpleType name="DataFilterOperator"&gt;
 ...
 * 
 */
@XmlType(name = "DataFilterOperator")
@XmlEnum
public enum DataFilterOperator {
    ...
    public static DataFilterOperator fromValue(String v) {
        for (DataFilterOperator c: DataFilterOperator.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
